...
/// @brief 3x3x3 cube vertex data generator — GPU-backend-agnostic.
///
/// Generates flat vertex buffers (position + color) that are uploaded to
/// whichever GPU backend is in use (OpenGL, WebGPU, Metal, DirectX).
/// Does NOT include any GPU headers.
